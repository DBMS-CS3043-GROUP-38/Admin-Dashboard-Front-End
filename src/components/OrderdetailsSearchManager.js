...
import { getOrderDetailsM, getOrderProductsM, getTrackingDetailsM } from '../services/apiService';
...
const OrderDetailsSearchCard = () => {
    ...
    const handleSearch = async () => {
        try {
            const data = await getOrderDetailsM(searchOrderID);
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            const products = await getOrderProductsM(searchOrderID);
            const tracking = await getTrackingDetailsM(searchOrderID);
