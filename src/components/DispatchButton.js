        ...
        <>
            ...
            >
                <Typography variant="h5">
                    Confirm Dispatch of the Train With Or Without Orders
                </Typography>
            </Button>
...
const ReceiveButton = ({  onReceive , resetData }) => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode);
    const [open, setOpen] = useState(false);
    const [dispatchedOrders, setDispatchedOrders] = useState(0);
    ...
    const handleSchedule = async () => {
        // Trigger scheduling logic
        const response = await onReceive(); // This function will schedule trains in the backend
        console.log(response);
    ...
    return (
        <>
            ...
            >
                <Typography variant="h5">
                    Confirm Receive of the train with or without orders
                </Typography>
            </Button>
...
export { DispatchButton, ReceiveButton };